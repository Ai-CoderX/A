...
module.exports = {
  ...
  AUTO_STATUS_MSG: settings.AUTO_STATUS_MSG || process.env.AUTO_STATUS_MSG || "*KHAN MD VIEWED YOUR STATUS 🤖*",
  ...
  DESCRIPTION: settings.DESCRIPTION || process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Jᴀᴡᴀᴅ TᴇᴄʜX*",
